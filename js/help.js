...
// --- Calculus ---
    ...
    "rk4": { "description": "Runge-Kutta 4th order ODE solver (fixed step).", "syntax": "rk4(f, y, t, y0, t0, t1, h)", "examples": ["rk4(y - t*t + 1, y, t, 0.5, 0, 2, 0.2)"] },
    "rk45": { "description": "Adaptive RK4/5 (Dormand-Prince) with error estimation & step-size control. Returns Vec of [t, y, err] rows + metadata.", "syntax": "rk45(f, y, t, y0, t0, t1, h0, tol, opts)", "examples": ["rk45(-0.5*y, y, t, 1, 0, 2, 0.1, 1e-6, [])", "rk45([y2, -y1], [y1,y2], t, [0,1], 0, 10, 0.1, 1e-6, [])"] },
    "odeplot": { "description": "Generates a plot from the solution table returned by rk4 or rk45.", "syntax": "odeplot(sol)", "examples": ["odeplot(rk45(-0.5*y, y, t, 1, 0, 2, 0.1, 1e-6, []))"] },
