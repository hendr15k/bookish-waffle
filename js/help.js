...
// --- Calculus ---
    ...
    "rk45": { "description": "Adaptive RK4/5 (Dormand-Prince) with error estimation & step-size control. Returns Vec of [t, y, err] rows + metadata.", "syntax": "rk45(f, y, t, y0, t0, t1, h0, tol, opts)", "examples": ["rk45(-0.5*y, y, t, 1, 0, 2, 0.1, 1e-6, [])", "rk45([y2, -y1], [y1,y2], t, [0,1], 0, 10, 0.1, 1e-6, [])", "rk45([y2, -c*y2 - k*y1], [y1, y2], t, [1, 0], 0, 20, 0.1, 1e-6, [])"] },
