...
class Call extends Expr {
    ...
    diff(varName) {
        ...
        // If not implemented, return symbolic diff
    ...
    toLatex() {
        ...
        if (this.funcName === 'integrate') {
            if (this.args.length === 2) {
                return `\\int \\left(${argsTex[0]}\\right) \\, d${argsTex[1]}`;
            } else if (this.args.length === 4) {
                return `\\int_{${argsTex[2]}}^{${argsTex[3]}} \\left(${argsTex[0]}\\right) \\, d${argsTex[1]}`;
            }
        }
        ...
        if (this.funcName === 'sum') {
             ...
             if (this.args.length === 4) {
                 return `\\sum_{${argsTex[1]}=${argsTex[2]}}^{${argsTex[3]}} \\left(${argsTex[0]}\\right)`;
             }
        }

        if (this.funcName === 'product') {
             if (this.args.length === 4) {
                 return `\\prod_{${argsTex[1]}=${argsTex[2]}}^{${argsTex[3]}} \\left(${argsTex[0]}\\right)`;
             }
        }
        ...
        if (this.funcName === 'limit') {
            ...
            if (this.args.length === 3) {
                return `\\lim_{${argsTex[1]} \\to ${argsTex[2]}} \\left(${argsTex[0]}\\right)`;
            }
        }
